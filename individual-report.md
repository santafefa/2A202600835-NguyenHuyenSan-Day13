...
## 1. Team Metadata
- `[GROUP_NAME]`: Individual (Nguyễn Huyền San)
- `[REPO_URL]`: https://github.com/santafefa/2A202600835-NguyenHuyenSan-day13
- `[MEMBERS]`:
...
- `[EVIDENCE_LINK]`: https://github.com/santafefa/2A202600835-NguyenHuyenSan-day13
